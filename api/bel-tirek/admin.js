...
// Protected by the same ADMIN_PASSWORD used for /admin/login.html —
// sent in the request body (not a session cookie), since this is meant
// to be called from a terminal/script, not a browser session.
