...
async function checkOrderStatus(orderId) {
  ...
  // .normalize('NFKC') — на случай, если банк присылает RC не обычными ASCII-
  // цифрами (например, широкими юникод-цифрами), которые визуально неотличимы
  // от "00" на экране, но не равны строке '00' при обычном сравнении. Именно
  // такое расхождение наблюдали: RC выглядел как "00", но сравнение не срабатывало.
  const approved = String(parsed.RC || '').normalize('NFKC').trim() === '00';
